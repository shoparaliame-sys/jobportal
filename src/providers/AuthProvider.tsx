...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  // If local token exists, wait for localLoading. Otherwise, just wait for oauthLoading.
  const hasLocalToken = !!localStorage.getItem("local_auth_token");
  const isLoading = oauthLoading || (hasLocalToken && !oauthUser ? localLoading : false);
